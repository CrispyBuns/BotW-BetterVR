...
lis r3, orig_act_GetCamera@ha
addi r3, r3, orig_act_GetCamera@l
mtctr r3
lwz r3, 0x1C(r1)
;bctrl ; bl orig_act_GetCamera
...
;0x02B8FEB8 = bla hook_act_GetCamera


hook_applyReverseCameraRotation:
lwz r0, 0x1C(r1)
mtlr r0
...
; rotate camera with VR controls
bla import.coreinit.hook_ApplyCameraRotation
...
;0x02DE3D8C = ba hook_applyReverseCameraRotation